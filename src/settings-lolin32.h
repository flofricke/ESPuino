...
#define RFID_MOSI                       33          // GPIO for master out slave in (RFID)
#define RFID_MISO                       35          // GPIO for master in slave out (RFID)
#define RFID_SCK                        32          // GPIO for clock-signal (RFID)

#ifdef RFID_READER_TYPE_PN5180
    #define RFID_BUSY                   12          // PN5180 BUSY PIN
